...
@Controller
@RequestMapping("/changed-report-redo")
public class ChangedRedoReportController extends HeaderCommonController {
    @Autowired
    ...
    public String list(Map<String,Object> data,
        ...
        data.put("tpl", safetyOverviewTpl().getJSONArray("groups").getJSONObject(4));
        PageRequest pr = getPageRequestData();
        Integer page = pr.getCurrentPage();
        Integer limit = pr.getLimit();
        JSONObject res = securityCheckApi.redoPage(ecmId, null, null, hiddenDangerGrade, startTime, endTime, null, page, limit);
        this.dealException(res);
